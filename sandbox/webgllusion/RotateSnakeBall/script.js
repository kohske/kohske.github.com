...
onload = function(){
    ...
    var e_ballsize = document.getElementById("ballsize");
    var e_mouse_view = document.getElementById("mouse_view");
    var e_lighting = document.getElementById("lighting");
    var e_wz = document.getElementById("white_zero");
    var e_bs = document.getElementById("bg_star");
    ...
    var count = 0;
    var ballsize = 1.0;
    var mouse_view = false;
    var lighting = 1;
    var bg_star = 1;
    
    // 恒常ループ
    (function(){
	ballsize = e_ballsize.value;
	mouse_view = e_mouse_view.checked;
	lighting = e_lighting.checked;
	white_zero = e_wz.checked;
	bg_star = e_bs.checked;
	...
	for (var i=0; i<N; ++i){ 
	    ...
	    if (mouse_view) q.toMatIV(qt, qMatrix);
